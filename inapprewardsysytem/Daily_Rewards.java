...
public class Daily_Rewards extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdsManager.loadRewardAd(Daily_Rewards.this);
...
//        showrewardedad=findViewById(R.id.advertismentrewards);
//        showrewardedad.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                AdsManager.showRewardAd(Daily_Rewards.this, currentUser.getUid());
//            }
//        });
